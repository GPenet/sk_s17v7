...
//=============== uas collector 
int limsize, floors;
uint64_t  tuaold[TUA64_12SIZE],// previous non hit uas infinal table of uas for bands 1+2
tua[TUA64_12SIZE]// 
...
struct G17B3HANDLER {
	...
	int known_b3, rknown_b3, active_b3, ib3, nb3,
		 ndead, wactive0, nmiss, //ncritical,
		irloop, stack;
